...
function panelUrl(alert) {
  // A origem observada na requisição vence a configuração: é sempre o endereço
  // pelo qual o sistema está realmente sendo acessado.
  const base = alert.baseUrl || process.env.PUBLIC_APP_URL || process.env.CLOUD_API_URL;
