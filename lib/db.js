...
const memory = globalThis.__agroRiskMemory || {
  telemetry: [], configs: new Map(), logs: [], zones: [], commands: new Map(), locations: new Map(), machines: new Map(), users: new Map(), pushSubscriptions: new Map(), telegramRecipients: new Map(), telegramCodes: new Map(),
};
