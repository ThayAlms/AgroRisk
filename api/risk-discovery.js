...
module.exports = async (request, response) => {
  ...
  try {
    ...
    const query = `[out:json][timeout:25];(nwr(around:${radius},${latitude},${longitude})["natural"="water"];nwr(around:${radius},${latitude},${longitude})["waterway"~"^(river|stream|canal|drain)$"];nwr(around:${radius},${latitude},${longitude})["natural"="wetland"];nwr(around:${radius},${latitude},${longitude})["hazard"="flood"];nwr(around:${radius},${latitude},${longitude})["flood_prone"="yes"];nwr(around:${radius},${latitude},${longitude})["landuse"="quarry"];nwr(around:${radius},${latitude},${longitude})["natural"="cliff"];nwr(around:${radius},${latitude},${longitude})["man_made"="embankment"];);out tags geom;`;
